...
dataset = ANALYTIC_DIR / ("analytic_sepsis_steroids_v1.parquet")
...
with pd.option_context('display.max_columns', None):
    ...
    print(f"- Number of treated (treat_steroid=1): {n_treated} ({n_treated / n_total:.2%})")
    print(f"- Number of untreated (treat_steroid=0): {n_untreated} ({n_untreated / n_total:.2%})")
